...
function scene:create(event)
    ...
    local walkOptions = require("assets.images.characters.sprite-0004")
    local walkSheet = graphics.newImageSheet("assets/images/characters/Sprite-0004.png", walkOptions)

    -- Load JUMP sprite sheet
    local jumpOptions = require("assets.images.characters.sprite-0004jump")
    local jumpSheet = graphics.newImageSheet("assets/images/characters/Sprite-0004jump.png", jumpOptions)
